...
class SFTDataBuilder:
    ...
    def build(self, samples: Iterable[FakeNewsSample]) -> List[Dict[str, object]]:
        ...
        for sample in samples:
            ...
            preliminary_output = self.analyzer_agent.next_action(sample, [], analyzer_observation)
            ...
            worker_output = self.worker_agent.next_action(sample, ["preliminary_analysis"], worker_observation)
            ...
            verdict_output = self.analyzer_agent.next_action(
                sample,
                ["preliminary_analysis", "worker_skill"],
                verdict_observation,
            )
